        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-300 text-base sm:text-lg leading-relaxed mb-8">
              في مطعم الشريعى، لا نؤمن بأن الوجبات السريعة تعني التنازل عن الجودة. بدأنا بهدف واضح: تقديم فرايد تشكن وبرجر بمستوى المطاعم العالمية الفاخرة ولكن بنكهة مصرية أصيلة وبأسعار في متناول الجميع.
            </p>
